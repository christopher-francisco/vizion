...
map("n", "<leader>fe", ':e <c-r>=expand("%:p:h")<cr>/', { desc = "Open file in current split/window" })
map("n", "<leader>_f", ':sp <c-r>=expand("%:p:h")<cr>/', { desc = "Open file in split" })
map("n", "<leader>|f", ':vsp <c-r>=expand("%:p:h")<cr>/', { desc = "Open file in vertical split" })
map("n", "<leader><tab>f", ':tabe <c-r>=expand("%:p:h")<cr>/', { desc = "Open file in tab" })
map("n", "<leader>fp", '<cmd>echo expand("%")<cr>', { desc = "Display the path of the file" })

map("n", "<leader>xl", "<cmd>lopen<cr>", { desc = "Location List" })
map("n", "<leader>xq", "<cmd>copen<cr>", { desc = "Quickfix List" })
map("n", "<leader>xft", ":grep -t ts FIXME ", { desc = "FIXME (Typescript) to quickfix list" })

-- Quickfix
map("n", "[q", vim.cmd.cprev, { desc = "Previous Quickfix" })
map("n", "]q", vim.cmd.cnext, { desc = "Next Quickfix" })
map("n", "[Q", vim.cmd.cfirst, { desc = "Previous Quickfix" })
map("n", "]Q", vim.cmd.clast, { desc = "Next Quickfix" })
